		...
		<div class="container">
			<div class="grid">
				...
				<div class="col-sm-4 col-lg-4 col-md-4 col-xs-12">
					...
					<div class="tooltip">
						<span class="tooltiptext">Live: The product is actively being manufactured and sold.</span>
					</div> 
					...
					?>
					<a target="_blank" href="<?php echo ('/sites/default/files/'.file_uri_target($support[$target]->field_datasheet["und"][0]["uri"]));?>" title="Download the datasheet.">
		...
		<?php foreach ($support[$target]->field_datasheet["und"] as $key => $value): ?>
			...
			?>
				...
				<td class="table__cell" data-table-header="">
					<a class="button button button--simple" target="_blank" href="<?php echo ('/sites/default/files/'.file_uri_target($value["uri"]));?>" data-icon-after="" data-icon-before="">Download</a>
				</td>
			</tr>
		<?php endforeach ?>
		</tbody>
...
<div class="table table--alternate">
	<table class="table__element">
		...
		var_dump($filename);
		$dumpy = ob_get_clean();
		watchdog ('dlink','field_datasheet'.$dumpy);*/
...
<tr class="table__row">
<td class="table__cell" data-table-header="Version">-</td>
<td class="table__cell" data-table-header="Description">Additional downloads</td>
<td class="table__cell" data-table-header="Date">-</td>
<td class="table__cell" data-table-header="">
<a class="button button button--simple" target="_blank" href="<?php echo ('/sites/default/files/'.file_uri_target($value["uri"]));?>"  data-icon-after="" data-icon-before="">Download</a>
</td>
...
<tr class="table__row">
<td class="table__cell" data-table-header="Version">-</td>
<td class="table__cell" data-table-header="Description">Software</td>
<td class="table__cell" data-table-header="Date">-</td>
<td class="table__cell" data-table-header="">
<a class="button button button--simple" target="_blank" href="<?php echo ('/sites/default/files/'.file_uri_target($value["uri"]));?>"  data-icon-after="" data-icon-before="">Download</a>
</td>
