 ...
 */
function dlink_preprocess_page(array &$variables) {
  ...
  if (bootstrap_setting('navbar_inverse')) {
	...
	if (isset ($variables['node']) and ($variables['node']->type == 'home_products' or $variables['node']->type == 'business_products')){
		$variables['page']['add_bread_crump_button']=true;
	}
}
 ...
 */
function dlink_process_page(array &$variables) {
  $variables['navbar_classes'] = implode(' ', $variables['navbar_classes_array']);
	if (isset ($variables['node']) and ($variables['node']->type == 'home_products' or $variables['node']->type == 'business_products')){
		$variables['page']['add_bread_crump_button']=true;
	}
	$variables['page']['search_form'] = drupal_get_form('search_block_form');
